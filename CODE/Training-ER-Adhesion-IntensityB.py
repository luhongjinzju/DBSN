...
if __name__ == "__main__":
    ...
    for epoch in range(5001):
        ...
        torch.save(model.state_dict(),"/home/jlh/DBSN/Models/ER_Adhesion-IB/Models_tmp.pkl")
        if epoch in range(0,5001,10):
            torch.save(model.state_dict(),"/home/jlh/DBSN/Models/ER_Adhesion-IB/Models_"+str(epoch)+".pkl")
