...
if __name__ == "__main__":
    ...
    input_size= 1
    output_size = 2
    SRRFDATASET = ReconsDataset(all_data_path="/home/jlh/DBSN/Cropped_images_ER_Adhesion/Tesing_Input/",
                                transform = ToTensor(),
                                in_size = 256)   
    ...
    for model_num in range(0,5001,10):
        print(model_num)
        model.cuda(cuda)
        model.load_state_dict(torch.load("/home/jlh/DBSN/Models/ER_Adhesion/Models_"+str(model_num)+".pkl"))
        model.eval()
        file_path = '/home/jlh/DBSN/Prediction/ER_Adhesion/Pred_'+str(model_num)+'/'
