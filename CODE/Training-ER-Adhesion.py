...
class ReconsDataset(torch.utils.data.Dataset):
     def __init__(self, all_data_path, transform, in_size):
        ...
        self.dirs_data = os.listdir(self.all_data_path+'GT_ER/')
     ...
     def __getitem__(self, idx):
         ...
         file_name = os.path.join(self.all_data_path+'GT_ER/', dirs[idx])
         I = io.imread(file_name)
         data_gt[:,:,0] = I/max_intensity
         file_name = os.path.join(self.all_data_path+'GT_Adhesion/', dirs[idx])
         I = io.imread(file_name)
...
if __name__ == "__main__":
    ...
    for epoch in range(5001):
        ...
        torch.save(model.state_dict(),"/home/jlh/DBSN/Models/ER_Adhesion_SS/Models_tmp.pkl")
        if epoch in range(0,5001,10):
            torch.save(model.state_dict(),"/home/jlh/DBSN/Models/ER_Adhesion_SS/Models_"+str(epoch)+".pkl")
