...
if __name__ == "__main__":
    ...
    gt_path="/media/star/data-zju-win/YongXinSIM/202302/Testing_ER_Adhesion-2/Adhesion/"
    dirs = os.listdir(gt_path) 
    p_value_avg = np.zeros((501, 6))
    
    for pred_num in range(10,5001,10):
        pred_path = "/media/star/data-zju-win/YongXinSIM/202302/0-Predictions/SC_ER_Adhesion-2/Pred_"+ str(pred_num) + "/"
        data_save = "/media/star/ZJU-DATA/DL_Intensity_balance/Data/0-Data_4_training/YXSIM_code_testing/Transfer_Learning_CODE/Performance/SC_Adhesion/Pred_"+ str(pred_num) + '.xls'
        ...
        for idx in range(len(dirs)):
            ...
            p_value[idx,0] = float(dirs[idx][7:-4])
        ...
        for k,p in enumerate(p_value):
            for j,q in enumerate(p):
                    table.write(k,j,q)
        file.save(data_save)
    data_save = "/media/star/ZJU-DATA/DL_Intensity_balance/Data/0-Data_4_training/YXSIM_code_testing/Transfer_Learning_CODE/Performance/SC_Adhesion/avg_all.xls"
    file = Workbook(encoding = 'utf-8')
