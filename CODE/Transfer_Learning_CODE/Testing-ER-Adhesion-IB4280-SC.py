...
if __name__ == "__main__":
    ...
    for model_num in range(10,5001,10):
        print(model_num)
        model.cuda(cuda)
        model.load_state_dict(torch.load("/home/jlh/20221208/Models/YXSIM_transfer/SC-2/Models_"+str(model_num)+".pkl"))
        model.eval()
        file_path = '/home/jlh/20221208/Prediction/YXSIM_transfer/SC-2/Pred_'+str(model_num)+'/'
