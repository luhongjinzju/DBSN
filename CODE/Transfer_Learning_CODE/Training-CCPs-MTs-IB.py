...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("/home/jlh/20220916/Models/CCPs_MTs-DL-intensity/Models_3730.pkl"))
    ...
    for epoch in range(5001):
        ...
        torch.save(model.state_dict(),"/home/jlh/20220916/Models/YXSIM_transfer/IB/Models_tmp.pkl")
        if epoch in range(0,5001,10):
            torch.save(model.state_dict(),"/home/jlh/20220916/Models/YXSIM_transfer/IB/Models_"+str(epoch)+".pkl")
