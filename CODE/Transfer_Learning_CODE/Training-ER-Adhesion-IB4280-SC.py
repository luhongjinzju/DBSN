...
if __name__ == "__main__":
    ...
    input_size = 1
    output_size = 2
    SRRFDATASET = ReconsDataset(all_data_path="/home/jlh/20221208/0-SIM-YongXin/Training_ER_Adhesion/",
                                transform = ToTensor(),
                                in_size = 512)
    ...
    model_IB.cuda(cuda)
    model_IB.load_state_dict(torch.load("/home/jlh/20221208/Models/YXSIM_transfer/IB/Models_4280.pkl"))
    model_IB.eval()
    
    model = UNet(n_channels=input_size, n_classes=output_size)
    model.load_state_dict(torch.load("/home/jlh/20221208/Models/ER_Adhesion/Channel_S/Models_5000.pkl"))
    ...
    for epoch in range(5001):
        ...
        torch.save(model.state_dict(),"/home/jlh/20221208/Models/YXSIM_transfer/SC-2/Models_tmp.pkl")
        if epoch in range(0,5001,10):
            torch.save(model.state_dict(),"/home/jlh/20221208/Models/YXSIM_transfer/SC-2/Models_"+str(epoch)+".pkl")
