...
if __name__ == "__main__":
    ...
    for model_num in range(0,5001,10):
        print(model_num)
        model.cuda(cuda)
        model.load_state_dict(torch.load("/home/jlh/20220916/Models/YXSIM_transfer/IB/Models_"+str(model_num)+".pkl"))
        model.eval()
        file_path = '/home/jlh/20220916/Prediction/SIM_YongXin_testing/YXSIM_transfer/IB/Pred_'+str(model_num)+'/'
