...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("/home/jlh/20221208/Models/ER_Adhesion/Intensity_B/Models_4670.pkl"))
    ...
    for epoch in range(5001):
        ...
        torch.save(model.state_dict(),"/home/jlh/20221208/Models/YXSIM_transfer/IB/Models_tmp.pkl")
        if epoch in range(0,5001,10):
            torch.save(model.state_dict(),"/home/jlh/20221208/Models/YXSIM_transfer/IB/Models_"+str(epoch)+".pkl")
